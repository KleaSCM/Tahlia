...
pub fn build(b: *std.Build) void {
    ...
    const compile_step = b.addSystemCommand(&.{ "zig", "c++", "-std=c++17", "-Wall", "-Wextra", "-I", "include", "src/main.cpp", "src/core/audit.cpp", "src/core/asset_manager.cpp", "src/core/asset_indexer.cpp", "src/core/asset_validator.cpp", "src/core/import_manager.cpp", "-o", "zig-out/bin/blender_asset_manager" });
    ...
    const test_compile = b.addSystemCommand(&.{ "zig", "c++", "-std=c++17", "-Wall", "-Wextra", "-I", "include", "src/core/audit.cpp", "src/core/import_manager.cpp", "Tests/test_audit.cpp", "-o", "zig-out/bin/test_audit", "-lCatch2", "-lstdc++" });
    ...
    const validator_test_compile = b.addSystemCommand(&.{ "zig", "c++", "-std=c++17", "-Wall", "-Wextra", "-I", "include", "src/core/asset_validator.cpp", "src/core/import_manager.cpp", "Tests/test_asset_validator.cpp", "-o", "zig-out/bin/test_asset_validator", "-lCatch2", "-lstdc++" });
